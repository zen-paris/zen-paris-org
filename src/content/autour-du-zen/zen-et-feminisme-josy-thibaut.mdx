...
draft: false
image:
  src: "/assets/zen-feminisme-josy-thibaut-mlf.webp"
...
Josy (1925-2017), mère de [maître Kosen Thibaut](maitre-kosen-thibaut), était à la fois une pratiquante sans faille du zen et une militante féministe aguerrie. Elle a longtemps animé chez elle un groupe de zazen, qui fut à l'origine du [dojo Zen Paris](zazen-paris).

<div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-2 gap-4 max-w-6xl mx-auto">

  <details class="accordion border border-gray-300 rounded-md bg-gray-50 p-3 sm:p-4 md:p-5">
    <summary class="cursor-pointer font-semibold text-sky-700 flex items-center gap-3">
      <img
        src="/assets/greve-des-femmes.webp"
        alt=""
        loading="lazy"
        class="w-12 h-12 object-cover rounded shrink-0"
      />
      <span>GRRRR-rêve des femmes</span>
    </summary>
...
Mon MLF – Marie-Jo Bonnet
  ...
  <details class="accordion border border-gray-300 rounded-md bg-gray-50 p-3 sm:p-4 md:p-5">
    <summary class="cursor-pointer font-semibold text-sky-700 flex items-center gap-3">
      <img
        src="/assets/quand-les-femmes-s-aiment-les-hommes-ne-recoltent-pas.webp"
        alt=""
        loading="lazy"
        class="w-12 h-12 object-cover rounded shrink-0"
      />
      <span>Quand les femmes s’aiment</span>
    </summary>
    <div class="mt-3 text-sm leading-relaxed">
...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-6xl mx-auto">
  ...
  <details class="accordion border border-gray-300 rounded-md bg-gray-50 p-3 sm:p-4 md:p-5">
    ...
    <div class="mt-3 text-sm leading-relaxed">
      ...
      <blockquote class="italic text-lg leading-relaxed mx-4 my-6 border-l-4 border-sky-600 pl-4">

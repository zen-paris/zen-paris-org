    ...
    <div class="mt-3 text-sm leading-relaxed">
      <section class="bibliography">
        <dl>
          ...
          <dd>
            <ul class="list-disc list-inside">
              <li><em>The Essential Dogen: Writings of the Great Zen Master</em></li>
              <li><em>The Vimalakīrti Sūtra</em></li>
              <li><em>Sit: Zen Teachings of Master Taisen Deshimaru</em> — Philippe Coupey</li>
              <li><em>Sa véritable dimension</em> — Maître Kosen</li>
              <li><em>The Lotus Sūtra</em></li>
              <li><em>El zen es la mayor patraña de todos los tiempos</em> — Kodo Sawaki</li>
